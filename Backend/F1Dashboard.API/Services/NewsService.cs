...
public class NewsService
{
    ...
    public async Task<string> GetF1NewsAsync()
    {
        ...
        var url = "everything?q=(Formula+1+OR+F1+OR+%22Grand+Prix%22+OR+%22Formula+One%22)+AND+(race+OR+driver+OR+championship+OR+qualifying+OR+regulation+OR+team)&language=en&sortBy=publishedAt&pageSize=12&domains=skysports.com,espn.com,formula1.com,autosport.com,motorsport.com,bbc.com,theguardian.com,racer.com&apiKey=yourkey";
